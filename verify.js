...
async function doVerify() {
  ...
  setStatus('found', `
    ...
    <div class="vs-community">
      <div class="vs-community-title">Rejoins la communauté SoRunning SNCF</div>
      <div class="vs-community-links">
        <a class="vs-community-btn vs-community-btn--strava" href="https://www.strava.com/clubs/SoRunningSNCF" target="_blank" rel="noopener noreferrer">
          <svg class="vs-community-logo" viewBox="0 0 24 24" aria-hidden="true"><path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/></svg>
          <span>Club Strava</span>
        </a>
        <a class="vs-community-btn vs-community-btn--engage" href="https://engage.cloud.microsoft/main/org/sncf.fr/groups/eyJfdHlwZSI6Ikdyb3VwIiwiaWQiOiI2Nzg4NTg4In0" target="_blank" rel="noopener noreferrer">
          <svg class="vs-community-logo" viewBox="0 0 24 24" aria-hidden="true"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
