...
├── dossard.html        # Page publique — récupération des dossards PNG
...
├── dossard.js          # Logique de la page de récupération des dossards
...
├── dossards/           # PNG des dossards générés par l'admin (nommés XXXX.png)
└── data/
...
## Page de récupération des dossards (`dossard.html`)

Permet à chaque participant de **télécharger son ou ses dossards PNG** en saisissant son numéro d'inscription. La page lit le CSV anonymisé, identifie les épreuves inscrites et affiche une carte par dossard avec aperçu et bouton de téléchargement direct.

### Fonctionnement

1. Le participant saisit son numéro d'inscription et clique sur **Récupérer**.
2. La page charge `data/participants_anonymises_Challenge_Connecté_2026.csv` et retrouve ses épreuves.
